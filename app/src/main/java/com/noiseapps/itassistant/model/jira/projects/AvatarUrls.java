...
public class AvatarUrls implements Parcelable {
     ...
     * @param _16x16
     */
    public AvatarUrls(String _24x24, String _16x16, String _32x32, String _48x48) {
        this._24x24 = _24x24;
        this._16x16 = _16x16;
        this._32x32 = _32x32;
        this._48x48 = _48x48;
    ...
    @Override
    public int hashCode() {
        return new HashCodeBuilder().append(_24x24).append(_16x16).append(_32x32).append(_48x48).toHashCode();
    }
    ...
    public boolean equals(Object other) {
        ...
        return new EqualsBuilder().append(_24x24, rhs._24x24).append(_16x16, rhs._16x16).append(_32x32, rhs._32x32).append(_48x48, rhs._48x48).isEquals();
    }
